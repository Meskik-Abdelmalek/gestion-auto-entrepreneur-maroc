...
// This file is auto-generated by install.php — do not edit manually.
// If you need to reconfigure, run install.php again.
define('DB_HOST',    getenv('AE_DB_HOST')    ?: 'localhost');
define('DB_USER',    getenv('AE_DB_USER')    ?: '');
define('DB_PASS',    getenv('AE_DB_PASS')    ?: '');
define('DB_NAME',    getenv('AE_DB_NAME')    ?: '');
